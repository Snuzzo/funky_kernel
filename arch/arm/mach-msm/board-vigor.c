...
static int wireless_charger_detect(void)
{
	...
	wireless_gpio = gpio_get_value(PM8058_GPIO_PM_TO_SYS(VIGOR_WIRELESS_CHG_OK));
...
{
	struct pm_gpio gpio_cfg_MHLAUD_USBz = {
	...
	pm8xxx_gpio_config(PM8058_GPIO_PM_TO_SYS(VIGOR_MHLAUD_USBz_SW), &gpio_cfg_MHLAUD_USBz);
	...
	case PATH_MHL:
	{
		...
		gpio_set_value(PM8058_GPIO_PM_TO_SYS(VIGOR_MHLAUD_USBz_SW), (mhl ^ !polarity) ? 1 : 0);
...
static struct flashlight_platform_data flashlight_data = {
	.gpio_init 		= config_flashlight_gpios_aat1271,
...
static struct TPS61310_flashlight_platform_data vigor_flashlight_data_XB = {
...
static int camera_pm8058_power(int power)
{
	...
	/*.inv_int_pol = 1 => invert director as SW definition if use HW defining Director*/
		struct pm_gpio camera_3h2_rst_pin_on = {
			.direction		= PM_GPIO_DIR_OUT,
			.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
			.output_value	= 1,
			...
			struct pm_gpio camera_3h2_rst_pin_off = {
			.direction		= PM_GPIO_DIR_OUT,
			.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
			.output_value	= 0,
	...
	if (power == 1)
		pm8xxx_gpio_config(PM8058_GPIO_PM_TO_SYS(VIGOR_CAM1_RST), &camera_3h2_rst_pin_on);
	else
		pm8xxx_gpio_config(PM8058_GPIO_PM_TO_SYS(VIGOR_CAM1_RST), &camera_3h2_rst_pin_off);
...
/* HTC_START linear led 20111011 */
static struct camera_led_est msm_camera_sensor_ov8830_led_table[] = {
	{
		.enable = 0,
		.led_state = FL_MODE_OFF,
		.current_ma = 0,
...
static struct camera_led_info msm_camera_sensor_ov8830_led_info = {
	.enable = 1,
	.low_limit_led_state = FL_MODE_TORCH,
	.max_led_current_ma = 800,
	.num_led_est_table = ARRAY_SIZE(msm_camera_sensor_ov8830_led_table),
};

static struct camera_flash_info msm_camera_sensor_ov8830_flash_info = {
	.led_info = &msm_camera_sensor_ov8830_led_info,
	.led_est_table = msm_camera_sensor_ov8830_led_table,
};
...
static struct msm_camera_sensor_info msm_camera_sensor_ov8830_data = {
	...
	.flash_cfg	= &msm_camera_sensor_ov8830_flash_cfg, /* HTC linear led 20111011 */
	.mirror_mode = 0,
	.csi_if			= 1,
	.dev_node		= 0
};
...
static uint32_t mhl_init_gpio[] = {
	GPIO_CFG(VIGOR_GPIO_MHL_RST_N, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(VIGOR_GPIO_MHL_INTR_N, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
};

static uint32_t msm_hdmi_off_gpio[] = {
	GPIO_CFG(VIGOR_GPIO_MHL_SCL,  0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(VIGOR_GPIO_MHL_SDA,  0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(VIGOR_GPIO_MHL_HPD,  0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
};

static uint32_t msm_hdmi_on_gpio[] = {
	GPIO_CFG(VIGOR_GPIO_MHL_SCL,  1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
	GPIO_CFG(VIGOR_GPIO_MHL_SDA,  1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
	GPIO_CFG(VIGOR_GPIO_MHL_HPD,  1, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
};
...
static void mhl_sii9234_1v2_power(bool enable)
{
	...
	struct pm_gpio gpio_cfg_MHL_5V = {
		.direction	= PM_GPIO_DIR_OUT,
		.output_value	= 0,
		.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		.pull		= PM_GPIO_PULL_NO,
	...
	if (!init) {
		pm8xxx_gpio_config(PM8058_GPIO_PM_TO_SYS(VIGOR_MHL_5V), &gpio_cfg_MHL_5V);
		init = true;
	}
...
static T_MHL_PLATFORM_DATA mhl_sii9234_device_data = {
	.gpio_intr = VIGOR_GPIO_MHL_INTR_N,
	.gpio_reset = VIGOR_GPIO_MHL_RST_N,
...
{
	{
		...
		.irq = MSM_GPIO_TO_INT(VIGOR_GPIO_MHL_INTR_N)
	},
};
#endif
#endif
...
static uint32_t gsbi4_gpio_table_gpio[] = {
	GPIO_CFG(VIGOR_CAM_I2C_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(VIGOR_CAM_I2C_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};
...
static uint32_t gsbi5_gpio_table_gpio[] = {
	GPIO_CFG(VIGOR_TP_I2C_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(VIGOR_TP_I2C_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};
...
static uint32_t gsbi12_gpio_table_gpio[] = {
	GPIO_CFG(VIGOR_GPIO_SENSOR_I2C_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(VIGOR_GPIO_SENSOR_I2C_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};
...
static struct bcm_bt_lpm_platform_data bcm_bt_lpm_pdata = {
	.gpio_wake = VIGOR_GPIO_BT_CHIP_WAKE,
	.gpio_host_wake = VIGOR_GPIO_BT_HOST_WAKE,
	.request_clock_off_locked = msm_hs_request_clock_off_locked,
	.request_clock_on_locked = msm_hs_request_clock_on_locked,
};

struct platform_device vigor_bcm_bt_lpm_device = {
	.name = "bcm_bt_lpm",
	.id = 0,
	.dev = {
...
static struct htc_sleep_clk_platform_data htc_slp_clk_data = {
	.sleep_clk_pin = PM8058_GPIO_PM_TO_SYS(VIGOR_WIFI_BT_SLEEP_CLK),
...
static struct rpm_regulator_init_data rpm_regulator_init_data[] = {
	...
	RPM_LDO(PM8058_L0,  0, 1, 0, 1200000, 1200000, LDO300HMIN),
	RPM_LDO(PM8058_L1,  0, 1, 0, 1200000, 1200000, LDO150HMIN), /* N/A */
	RPM_LDO(PM8058_L2,  0, 1, 0, 1200000, 1200000, LDO150HMIN), /* N/A */
	...
	RPM_LDO(PM8058_L12, 0, 1, 0, 3200000, 3200000, LDO150HMIN), /* N/A */
	...
	RPM_LDO(PM8058_L17, 0, 1, 0, 1200000, 1200000, LDO150HMIN), /* N/A */
	RPM_LDO(PM8058_L18, 0, 1, 1, 2200000, 2200000, LDO150HMIN),
	RPM_LDO(PM8058_L19, 0, 1, 0, 1800000, 1800000, LDO150HMIN), /* N/A */
	RPM_LDO(PM8058_L20, 0, 1, 0, 1200000, 1200000, LDO150HMIN), /* N/A */
	...
	RPM_LDO(PM8901_L4,  0, 1, 0, 1200000, 1200000, LDO150HMIN), /* N/A */
	RPM_LDO(PM8901_L5,  0, 1, 0, 2850000, 2850000, LDO300HMIN),
	RPM_LDO(PM8901_L6,  0, 1, 0, 2800000, 2800000, LDO300HMIN), /* N/A */
...
static void headset_init(void)
{
	...
	if ((board_build_flag() != MFG_BUILD) && !(get_kernel_flag() & KERNEL_FLAG_SERIAL_HSL_ENABLE)) {
...
static struct sdio_al_platform_data sdio_al_pdata = {
	...
	.peer_sdioc_version_minor = 0x0202,		/* QCT default: 0x0202 */
...
static int pm8058_gpios_init(void)
{
	...
	struct pm8058_gpio_cfg gpio_cfgs[] = {
		{ /* SD card detect */
			PM8058_GPIO_PM_TO_SYS(VIGOR_SD_DETECT_PIN),	/* 3 */
			{
		...
		{ /* Audio remote button event */
			PM8058_GPIO_PM_TO_SYS(VIGOR_AUD_REMO_PRES),	/* 6 */
			{
				.direction	  = PM_GPIO_DIR_IN,
				.pull		   = PM_GPIO_PULL_NO,
		...
		{ /* Audio Speaker Amplifier */
			PM8058_GPIO_PM_TO_SYS(VIGOR_AUD_AMP_EN),	/* 18 */
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 0,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{ /* Audio Receiver Amplifier */
			PM8058_GPIO_PM_TO_SYS(VIGOR_AUD_REC_EN),	/* 19 */
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 0,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{ /* Timpani Reset */
			PM8058_GPIO_PM_TO_SYS(VIGOR_AUD_QTR_RESET),	/* 20 */
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 1,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{ /* Green LED */
			PM8058_GPIO_PM_TO_SYS(VIGOR_GREEN_LED),	/* 23 */
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 1,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{ /* AMBER */
			PM8058_GPIO_PM_TO_SYS(VIGOR_AMBER_LED),	/* 24 */
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 1,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{ /* cm3629 P/L-sensor */
			PM8058_GPIO_PM_TO_SYS(VIGOR_PS_INT),
			{
				.direction	  = PM_GPIO_DIR_IN,
				.pull		   = PM_GPIO_PULL_UP_31P5,
				.vin_sel		= PM8058_GPIO_VIN_L5,
		...
		{ /* Audio Microphone Selector */
			PM8058_GPIO_PM_TO_SYS(VIGOR_AUD_MIC_SEL),	/* 36 */
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 0,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
...
/* MIC_BIAS1 is configured as back mic for OTHC */
...
static void vigor_mhl_init(void)
{
...
static struct platform_device *vigor_devices[] __initdata = {
	&ram_console_device,
	&msm_device_smd,
...
static struct msm_board_data htc_vigor_board_data __initdata = {
	.gpiomux_cfgs = htc_vigor_htc_gpiomux_cfgs,
};
...
struct sdcc_reg vreg_sdcc_vddp = {
			.reg_name = "8058_l5",
			.set_voltage_sup = 1,
			.level = 2850000,
			.always_on = 1,
...
static void __init msm8x60_init(struct msm_board_data *board_data)
{
	...
	*/
	...
	rc = msm_sdcc_vreg_enable(&vreg_sdcc_vddp);	/*Turn on Vddp 2.85V for remote control*/
	if (rc < 0)
