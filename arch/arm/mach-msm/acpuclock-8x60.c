 ...
 * The PLL hardware is capable of 192MHz to 1674MHz. The L_VALs
 * used for calibration should respect these limits. */
#define L_VAL_SCPLL_CAL_MIN	0x08 /* =  432 MHz with 27MHz source */
#define L_VAL_SCPLL_CAL_MAX	0x1F /* = 1674 MHz with 27MHz source */
...
static int __init acpuclk_8x60_init(struct acpuclk_soc_data *soc_data)
{
	...
	/* Improve boot time by ramping up CPUs immediately. */
		for_each_online_cpu(cpu)
			acpuclk_8x60_set_rate(cpu, CONFIG_BOOT_CLOCK, SETRATE_INIT);
